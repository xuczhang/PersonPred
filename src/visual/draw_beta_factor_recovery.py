...
class DataPlot:
    ...
    def draw_beta_factor_recovery(self, result_dir, k, p, bNoise):
        ...
        recovery_file = result_dir + 'beta_factor_' + str(k) + 'K_' + 'p' + str(p) + noise_str + '.mat'
        ...
        plt.plot(x, Y_RLHH, linestyle='-', marker='s', markersize=5, linewidth=3, color='#E6DE10', label='RLHH')
        plt.plot(x, Y_RMFPGC, linestyle='--', marker='>', markersize=5, linewidth=3, color='#782453', label='RMFP_GC')
        plt.plot(x, Y_RMFPMV, linestyle='-', marker='o', markersize=5, linewidth=3, color='red', label='RMFP_MV')
    ...
    def exp_beta_factor_recovery(self):
        ...
        k = 1
        bNoise = 1
        data_plot.draw_beta_factor_recovery(result_dir, k, p, bNoise)
'''
        ## figure 1b
        k = 2
        p = 100
...
if __name__ == '__main__':
    ...
    ''' beta factor recovery '''
    data_plot.exp_beta_factor_recovery()
